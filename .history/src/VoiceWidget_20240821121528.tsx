...
// import { leopardModel } from "./lib/leopardModel";
// import leopardModel from "./lib/leopardModel";
// import modelParams from "./lib/leopardModel";
// import { leopardModel } from "./lib/leopardModel";
...
export default function VoiceWidget() {
  ...
  const leopardModel1 = { publicPath: "models/student-leopard-v2.0.0-24-08-20--11-20-02.pv"}
  useEffect(() => {
    init(
      "9EXkduRw4yjnEXOHk8pp0MI+r53/sisWFsWhNxoQuzdbU8d2RXblWg==",
      leopardModel1
    );
  }, []);
